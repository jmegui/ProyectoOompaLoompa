...
class Jugador extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.cantidadAvance = 0.2;
    this.cantidadGiro = 0.03;
  ...
  avanzar(avanza){
    var direccion = this.cantidadAvance;
    if(!avanza) direccion = -this.cantidadAvance;

    this.translateOnAxis (this.frente, direccion);
  }
  
  girar(derecha){
    var angulo = this.cantidadGiro;
    if(derecha) angulo = -this.cantidadGiro;

    this.rotateOnAxis (this.vertical, angulo);
  }
